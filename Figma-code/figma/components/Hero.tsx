        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <h1 className="text-6xl lg:text-7xl text-[#0A2E35] leading-tight">
              ...
              <span className="text-[#C9A961]">Elena Rodriguez</span>
            </h1>
            ...
            <div className="flex gap-8 pt-8 border-t border-[#E8B8B0]">
              <div>
                <div className="text-3xl text-[#C9A961]">500+</div>
                <div className="text-[#2D5A63]">Paintings Created</div>
              </div>
              <div>
                <div className="text-3xl text-[#C9A961]">15+</div>
          ...
          <div className="relative">
            ...
            <div className="relative">
              <ImageWithFallback
                src="https://images.unsplash.com/photo-1604227070389-b88fd2896af6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcnRpc3QlMjBwYWludGVyJTIwc3R1ZGlvfGVufDF8fHx8MTc2Mjg5MzAzNHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
