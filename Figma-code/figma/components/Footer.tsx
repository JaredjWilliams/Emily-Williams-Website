    ...
    <footer className="bg-[#0A2E35] text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-2xl mb-4">Elena Rodriguez</h3>
            <p className="text-[#E8B8B0] mb-4">
              Contemporary artist creating unique original paintings that inspire and captivate.
            </p>
        ...
        <div className="border-t border-[#2D5A63] pt-8 text-center text-[#E8B8B0]">
          <p>&copy; {new Date().getFullYear()} Elena Rodriguez. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
